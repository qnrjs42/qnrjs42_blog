---
date: '2021-08-08'
title: '[React-Native] M1 arm64 react native 세팅(with. expo & React Native CLI)'
...
> > 21.10.03 추가
> >
> > React Native CLI 0.66.0 버전 테스트 완료. 16번 참조
>
> > 21.09.05 추가
> >
> > 'react-native-image-picker', 'expo-image-picker' iOS 시뮬레이터에서 이미지 선택이 안 됩니다. (안드로이드, 실기기는 가능)
>
> > 21.08.08 추가
> >
...
<img src='/images/react-native/m1-arm64-setting/19.png' width='50%' />
