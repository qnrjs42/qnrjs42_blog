...
1. 'git remote -v'
origin  https://github.com/qnrjs42/qnrjs42_blog.git (fetch)
origin  https://github.com/qnrjs42/qnrjs42_blog.git (push)

2. 'git remote remove origin'

3. 'git remote add origin https://qnrjs42:my-access-token@github.com/qnrjs42/qnrjs42_blog.git'
